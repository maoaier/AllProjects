    ...
    QWidget(parent)
{
    ...
    m_pIpPart1->setGeometry(QRect(0+CTRL_X, CTRL_Y, 60, 20));
    m_pIpPart2->setGeometry(QRect(70+CTRL_X, CTRL_Y, 60, 20));
    m_pIpPart3->setGeometry(QRect(140+CTRL_X, CTRL_Y,60, 20));
    m_pIpPart4->setGeometry(QRect(210+CTRL_X, CTRL_Y, 60, 20));
     qDebug()<<"hello world"<<endl;
    m_pDot1->setText("-");
    m_pDot1->setGeometry(QRect(48+190, 5+CTRL_Y, 16, 16));
    m_pDot1->setAlignment(Qt::AlignCenter);

    m_pDot2->setText("-");
    m_pDot2->setGeometry(QRect(118+190, 5+CTRL_Y, 16, 16));
    m_pDot2->setAlignment(Qt::AlignCenter);

    m_pDot3->setText("-");
    m_pDot3->setGeometry(QRect(188+190, 5+CTRL_Y, 16, 16));
